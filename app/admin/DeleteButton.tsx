  ...
  return (
    <>
      <button
        ...
        disabled={isPending}
        aria-label={`Delete certificate for ${studentName}`}
        ...
        >
          ...
          >
            ...
            <h2 className="mt-1 font-display text-xl italic text-text-primary">
              Remove {studentName}&apos;s record?
            </h2>
            <p className="mt-2 text-sm text-text-secondary">
              This permanently deletes the certificate and its QR code
              becomes invalid. This can&apos;t be undone.
            </p>
