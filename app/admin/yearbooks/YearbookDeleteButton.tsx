...
import { deleteYearbook } from "./actions";

export default function YearbookDeleteButton({
  id,
  title,
}: {
  id: string;
  ...
  return (
    <>
      <button
        ...
        disabled={isPending}
        aria-label={`Delete yearbook ${title}`}
        ...
        >
          ...
          >
            ...
            <p className="mt-2 text-sm text-text-secondary">
              This permanently deletes the yearbook PDF and cover image from
